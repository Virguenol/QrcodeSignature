...
using AutoMapper;
using Grs.BioRestock.Shared.Exceptions;
...
using Grs.BioRestock.Infrastructure.Specifications;
...
namespace Grs.BioRestock.Infrastructure.Services.Identity
{
    public class UserService : IUserService
    {
        ...
        public async Task<IResult> RegisterAsync(RegisterRequest request, string origin)
        {
            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    await _userManager.AddToRoleAsync(user, RoleConstants.Animateur);
