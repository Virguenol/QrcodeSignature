...
namespace Grs.BioRestock.Shared.Wrapper
{
    ...
    public class Result<T> : Result, IResult<T>
    {
        ...
        public static Task<Result<T>> FailAsync(string message, T data)
        {
        ...
        public static Task<Result<T>> FailAsync(List<string> messages, T data)
        {
        ...
        public static Task<Result<T>> FailAsync(Exception e)
        {
